...
Steps in this analysis are similar to the steps taken in the [line transect analysis of winter wren data](https://examples.distancesampling.org/Distance-lines/linetransects.html).
...
```{r fig, echo=FALSE, fig.cap="Summer grazed pastures along Illinois River Arapaho National Wildlife Refuge, Colorado.  Figure from [@knopf_guild_1988].", outwidth='70%', eval=TRUE}
...
- because of the hump shape, plotting to assess fit of data to detection distribution usually assessed via `pdf=TRUE` argument added to `plot()` function
